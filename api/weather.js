export default async function handler(req, res) {
  // 1. Atur Header CORS di paling atas agar localhost bisa mengakses
  ...
  try {
    // 4. Ambil data cuaca dan geocoding lokasi secara paralel (Fitur andalan kode lama Anda)
    ...
    // 5. Kembalikan gabungan data ke aplikasi utama Anda
